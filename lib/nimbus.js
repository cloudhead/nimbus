...
this.Store.prototype = new(function () {
    ...
    this.update = function (id, partial, callback) {
        ...
        if (doc) {
            ...
            this._registerChange('update', doc);
    ...
    this.remove = function (id, callback) {
        var that = this;
        this._registerChange('remove', this.get(id));
    ...
    this._emitChange = function () {
        if (this._changesCallback) {
            var      that = this,
                eventType = this._registeredChange.eventType,
                      doc = this._registeredChange.doc;

            process.nextTick(function () {
                that._changesCallback(eventType, doc);
            });
            delete(this._registeredChange);
        }
    };

    this._registerChange = function (eventType, doc) {
        if (!this._registeredChange) {
            this._registeredChange = {eventType: eventType, doc: doc};
        }
    };
    ...
    this.inspect = function () {
        ...
        var ary = [];
        if (this.cache) {
            Object.keys(this.cache).map(function (k) {
